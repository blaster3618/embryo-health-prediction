"""
ResNet-18 Transfer Learning for Embryo Health Prediction
=========================================================

This script trains a ResNet-18 model for binary classification of embryo images
...
Features:
- Transfer learning with ResNet-18 (fine-tuning layer3, layer4, and fc)
...
class TransferLearningCNN(nn.Module):
    """
    ResNet-18 based transfer learning model for embryo classification.
    fc input features: 512 (ResNet-18) vs 2048 (ResNet-50).
    """
...
def main():
    print("=" * 70)
    print("ResNet-18 Transfer Learning for Embryo Health Prediction")
    print("=" * 70)
