...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">AI-Powered Classification using ResNet-18 Deep Learning</p>
            <div style="margin-top: 15px;">
                <span class="info-badge">📊 ResNet-18</span>
        ...
        <footer>
            FYP 1 - Embryo Health Prediction System | ResNet-18 Transfer Learning
        </footer>
    </div>
